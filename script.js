(function() {
  ...
  function renderBackgroundCode() {
    var background = document.querySelector('#background');
    var first = background.querySelector('.first');
    var second = background.querySelector('.second');
    first.innerHTML = second.innerHTML = tokenizeToHTML(skewTokenizer, code['background']);
  }
