(function() {
  ...
  function main() {
    ...
    document.getElementById('example-calculator').onmousedown = function() { editor.setValue(EXAMPLE_CALCULATOR, -1); };
    ...
    document.getElementById('example-sparks').onmousedown = function() { editor.setValue(EXAMPLE_SPARKS, -1); };
